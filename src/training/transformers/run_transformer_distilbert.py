...
def run() -> None:
    ...
    with mlflow.start_run(run_name="DistilBERT") as run_info:
        ...
        version = register_model(
            ...
            artifact_path="model",
            model_name=REGISTERED_MODEL_NAME_DISTILBERT
        )
        
        set_model_description(
            REGISTERED_MODEL_NAME_DISTILBERT,
            version=version,
            description="DistilBERT fine-tuned on Banking77 dataset. Demonstrate the best the ratio of quality and speed. Best model."
        )
