...
Являются наиболее эффективной технологией в решении задач классификации текстовых документов. В проекте используются модели `BERT` и `DistilBERT`, которые были дообучены под решение поставленной задачи.
